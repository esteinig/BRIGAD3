...
class Ring:
    ...
    def setOptions(self, name='Ring', color='black', height=20, tooltip=None):
...
class Blaster:
    ...
    def __init__(self, reference, genomes):
    ...
    def runBLAST(self):
        ...
        for genome in self.genomes:
            ...
            call([self.mode, '-query', os.path.join(os.getcwd(), genome), '-db', self.name_db, '-outfmt', '6', '-out',
